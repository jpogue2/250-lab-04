...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("jpogue/ipinfo")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("jpogue/ipinfo", on_message_from_ipinfo)

    # Subscribe to date
    client.subscribe("jpogue/date")
    client.message_callback_add("jpogue/date", on_message_from_date)

    # Subscribe to time
    client.subscribe("jpogue/time")
    client.message_callback_add("jpogue/time", on_message_from_time)

    # Subscribe to random without a custom message_callback_add() function.
    client.subscribe("jpogue/random")
